SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='index.docker.io/pdeshmuk/tanzu-java-web-app-source')
...
k8s_custom_deploy(
    ...
    image_selector='index.docker.io/pdeshmuk/tanzu-java-web-app-' + NAMESPACE,
    live_update=[
